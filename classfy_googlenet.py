...
net_file=caffe_root + 'googlenet_places205/deploy_places205.protxt'
caffe_model=caffe_root + 'googlenet_places205/googlenet_12_iter_80000.caffemodel' 
...
dicp = {} 
dicfile = open('googlenet_res.pkl','wb')
