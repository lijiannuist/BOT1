...
net_file=caffe_root + 'resnet_101/ResNet-101-deploy.prototxt'
caffe_model=caffe_root + 'resnet_101/resnet_101_iter_100000.caffemodel' 
...
dicp = {} 
dicfile = open('resnet101_res.pkl','wb')
